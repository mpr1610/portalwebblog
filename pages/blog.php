            ...
            <div class="conteudo-portal">
                <div class="header-conteudo-portal">    
                        <?php
                            ...
                            //aqui pedi para adicionar o isset
                            if (isset($categorias['nome']) == '') {
                            ...
                            if (isset($categorias['nome']) != '') {
                            $categorias['id'] = (int)$categorias['id'];
                            $query2 .= "WHERE categoria_id = $categorias[id]";
                            }
                            if (isset($_POST['parametro'])) {
                ...
                <div class="paginator"  >
                    ...
                    for($i = 1; $i <= $totalPaginas; $i++){
                        $catStr = (isset($categorias['nome']) != '') ? '/'.$categorias['slug'] : ' ';
                        if(isset($pagina )== $i)
                            echo '<a class="active-page" href="'.INCLUDE_PATH.'blog'.$catStr.'?pagina='.$i.'">'.$i.'</a>';
                        else
                            echo '<a href="'.INCLUDE_PATH.'blog?pagina='.$i.'">'.$i.'</a>';
                    }
}
                    ?>
                </div><!--paginator-->
