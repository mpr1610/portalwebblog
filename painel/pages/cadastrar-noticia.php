<div class="box-content">
            ...
            if(isset($_POST['acao'])){
                ...
                if($titulo == '' || $conteudo == ''){
                    ...
                    if(Painel::insert($arr))
                        ...
                        //Painel::alert('sucesso','O cadastro da notícia foi realizada com sucesso');
                }else{
    ...
    <label>Categorias:</label>
		...
		<div class="form-group">
			<label>Titulo:</label>
			<input type="text" name="titulo" value="<?php recoveryPost('titulo');?>" >
		</div><!--form-group-->
        ...
        <div class="form-group">
			...
			<textarea class="tinymce" name="conteudo"><?php recoveryPost('conteudo');?></textarea>
		</div><!--form-group-->
