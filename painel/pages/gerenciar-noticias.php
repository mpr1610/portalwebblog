...
<div class="box-content">
	<h2><i class="fa fa-id-card-o" aria-hidden="true"></i> Noticias Cadastradas</h2>
	...
	<table>
		...
		<tr>
			...
			<td><a class="btn edit" href="<?php echo INCLUDE_PATH_PAINEL ?>editar-noticias?id=<?php echo $value['id']; ?>"><i class="fa fa-pen"></i> Editar</a></td>
